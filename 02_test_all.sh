...
#  	    --test_filename "/kaggle/input/daataa5/task2_data/trans_data/test.json"       \
#      	--dev_filename "/kaggle/input/daataa5/task2_data/trans_data/val.json"      \
...
CUDA_VISIBLE_DEVICES=0 python run2_12.py --do_test --model_type roberta      \
     	--model_name_or_path microsoft/codebert-base   \
 	    --test_filename /kaggle/input/daataa5/task2_data/t5_data/test.json       \
     	--dev_filename /kaggle/input/daataa5/task2_data/t5_data/val.json      \
     	--load_model_path /kaggle/input/d/adilyn1/checkpoint-best-bleu/pytorch_model.bin \
